...
struct Functions {
  ...
  virtual TaskHandle_t xTaskCrateStatic(TaskFunction_t pxTaskCode,
...
struct FunctionsMock {
  ...
  MOCK_METHOD7(xTaskCreateStatic,
               TaskHandle_t(TaskFunction_t, const char* const, const uint32_t,
